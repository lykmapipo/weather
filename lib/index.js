...
const normalizePresentForecast = (forecast, city) => {
  ...
  presentForecast = common.mergeObjects(presentCity, {
    date: common.parseDate(lodash.get(presentForecast, 'issue'), 'YYYYMMDDHH'),
    ...
    sunRiseAt: lodash.get(presentForecast, 'sunrise'),
    sunSetAt: lodash.get(presentForecast, 'sunset'),
    moonRiseAt: lodash.get(presentForecast, 'moonrise'),
    moonSetAt: lodash.get(presentForecast, 'moonset'),
    present: true,
  });
...
const normalizeWeekForecasts = (forecasts, city) => {
  ...
  const cityWeekForecasts = lodash.map(weekForecasts, (forecast) => {
    return common.mergeObjects(presentCity, {
      ...
      sunRiseAt: lodash.get(forecast, 'sunrise'),
      sunSetAt: lodash.get(forecast, 'sunset'),
      moonRiseAt: lodash.get(forecast, 'moonrise'),
      moonSetAt: lodash.get(forecast, 'moonset'),
      present: false,
    });
  });
